...
themeButton.addEventListener('click', () => {
    ...
    if (document.body.classList.contains('dark-theme')) {
        headerImg.src = '/013-Exercicio Bootstrap avançado (Young Rift)/assets/img/young-laranja-azulescuro-icon.png'; // Caminho para a imagem do tema escuro
    } else {
        headerImg.src = '/013-Exercicio Bootstrap avançado (Young Rift)/assets/img/young-laranjaebranco-icon.png'; // Caminho para a imagem do tema claro
    }
...
//IMPEDINDO DE ACESSAR POST
const post = document.querySelectorAll('.post-a');
...
//IMPEDINDO DE LER MAIS

const btnrm = document.querySelectorAll('#btnrm');

btnrm.forEach(btnrm => {
    btnrm.addEventListener('click', (e) => {
        e.preventDefault()
        const alert2 = document.getElementById('alert2');
        alert2.classList.toggle('show')
    })
});